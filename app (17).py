...
import pandas as pd
# import seaborn as sns  <-- Dihapus agar tidak error
    ...
    if komoditas_plot:
        ...
        if selected_commodities:
            ...
            for col in selected_commodities:
                # Menggunakan matplotlib murni menggantikan seaborn
                ax.plot(df['tahun_date'], df[col], label=col, marker='o', markersize=3)
